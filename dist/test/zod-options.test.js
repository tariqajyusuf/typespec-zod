import { createComponent as _$createComponent, memo as _$memo, createIntrinsic as _$createIntrinsic, mergeProps as _$mergeProps } from "@alloy-js/core/jsx-runtime";
...
import { ZodOptions } from "../src/components/ZodOptions.js";
import { zod, ZodCustomEmitOptions, ZodSchema, ZodSchemaDeclaration } from "../src/index.js";
import { createTestRunner, expectRender } from "./utils.js";
async function testFor(code, options = {}) {
...
export function expectOptionRender(test, options, expected) {
  let template;
  if ("types" in test) {
    template = _$createComponent(Output, {
      get program() {
        return test.program;
      },
      externals: [zod],
      get children() {
        return _$createComponent(SourceFile, {
          path: "test.ts",
          get children() {
            return _$createComponent(ZodOptions, {
              customEmit: options,
              get children() {
            ...
            return _$createComponent(ZodOptions, {
              ...
              get children() {
                return _$createComponent(StatementList, {
                  get children() {
                    return [_$memo(() => _$memo(() => !!test.type)() && _$createComponent(ZodSchemaDeclaration, {
                      get type() {
                        return test.type;
                      }
                    })), _$createComponent(ZodSchemaDeclaration, {
                      get type() {
                        return test.refContainer;
                      }
                    })];
                  }
                });
  ...
  let contents = output.contents[0].contents;
  if (contents.startsWith("import")) {
    contents = contents.split(/\n/).slice(2).join("\n");
  }
  expect(contents).toBe(d([expected]));
}
describe("customizing type kinds", () => {
  function typeKindOption(kind) {
  ...
  test("Boolean", async () => {
    const test = await testFor(`true`, {
      referenceOnly: true
    });
    expectOptionRender(test, typeKindOption("Boolean"), `
  ...
  test("Enum", async () => {
    ...
    expectOptionRender(test, typeKindOption("Enum"), `
        /* decl */;
        const RefTest = z.object({
          ref: /* ref */,
        });
  ...
  test("EnumMember", async () => {
    const test = await testFor(`enum Test { a: 1 }`, {
      reference: "Test.a"
    });
    expectOptionRender(test, typeKindOption("EnumMember"), `
  ...
  test("Intrinsic", async () => {
    const test = await testFor("null", {
      referenceOnly: true
    });
    expectOptionRender(test, typeKindOption("Intrinsic"), `
        const RefTest = z.object({
          ref: /* ref */,
        });
      `);
  ...
  test("Model", async () => {
    ...
    expectOptionRender(test, ZodCustomEmitOptions().forTypeKind("Model", {
      declare: props => ["/* A model */ ", _$memo(() => props.default)],
  ...
  test("ModelProperty", async () => {
    ...
    expectOptionRender(test, ZodCustomEmitOptions().forTypeKind("ModelProperty", {
      declare: props => ["/* decl */ ", _$memo(() => props.default)],
      reference: props => ["/* ref */"]
    }), `
        const Test = z.object({
          /* decl */ foo: z.string(),
  ...
  test("Number", async () => {
    const test = await testFor("1", {
      referenceOnly: true
    });
    expectOptionRender(test, typeKindOption("Number"), `
        const RefTest = z.object({
          ref: /* ref */,
        });
      `);
  ...
  test("Scalar", async () => {
    ...
    expectOptionRender(test, typeKindOption("Scalar"), `
        /* decl */;
        const RefTest = z.object({
          ref: /* ref */,
        });
  ...
  test("String", async () => {
    const test = await testFor(`"hi"`, {
      referenceOnly: true
    });
    expectOptionRender(test, typeKindOption("String"), `
        const RefTest = z.object({
          ref: /* ref */,
        });
      `);
  ...
  test("Tuple", async () => {
    const test = await testFor(`[1,2,3]`, {
      referenceOnly: true
    });
    expectOptionRender(test, typeKindOption("Tuple"), `
        const RefTest = z.object({
          ref: /* ref */,
        });
      `);
  ...
  test("Union", async () => {
    ...
    expectOptionRender(test, typeKindOption("Union"), `
        /* decl */;
        const RefTest = z.object({
          ref: /* ref */,
        });
  ...
  test("UnionVariant", async () => {
    const test = await testFor(`union Test { a: 1 }`, {
      reference: "Test.a"
    });
    expectOptionRender(test, typeKindOption("UnionVariant"), `
...
describe("customizing specific types", () => {
  ...
  test("built-in", async () => {
    const test = await testFor(`boolean`, {
      referenceOnly: true
    });
    expectOptionRender(test, typeOption($(test.program).builtin.boolean), `
        const RefTest = z.object({
          ref: /* ref */,
        });
      `);
  ...
  test("enum", async () => {
    const test = await testFor(`enum Test {}`);
    expectOptionRender(test, typeOption(test.type), `
        /* decl */;
        const RefTest = z.object({
          ref: /* ref */,
        });
  ...
  test("enum member", async () => {
    const test = await testFor(`enum Test { x: 1 }`, {
      reference: "Test.x"
    });
    expectOptionRender(test, typeOption(test.refType), `
        const Test = z.enum([/* decl */]);
        const RefTest = z.object({
          ref: /* ref */,
        });
  ...
  test("intrinsic", async () => {
    ...
    expectOptionRender(test, typeOption($(test.program).intrinsic.null), `
        const RefTest = z.object({
          ref: /* ref */,
        });
      `);
  ...
  test("model", async () => {
    const test = await testFor(`model Test {}`);
    expectOptionRender(test, ZodCustomEmitOptions().forType(test.type, {
      declare: props => ["/* A model */ ", _$memo(() => props.default)],
      reference: props => ["/* ref to a model */"]
    }), `
        /* A model */ const Test = z.object({});
  ...
  test("model property", async () => {
    ...
    expectOptionRender(test, ZodCustomEmitOptions().forType(test.refType, {
  ...
  test("union variant", async () => {
    const test = await testFor(`union Test { x: 1 }`, {
      reference: "Test.x"
    });
    expectOptionRender(test, typeOption(test.refType), `
        const Test = z.union([z.literal(1)]);
...
describe("type customization signatures", () => {
  describe("customizing a variable declaration", () => {
    test("props.default", async () => {
      ...
      const options = ZodCustomEmitOptions().forTypeKind("Model", {
        declare(props) {
          return ["// a model declaration", _$createIntrinsic("hbr", {}), _$memo(() => props.default)];
        }
      });
      await expectOptionRender(test, options, `
        // a model declaration
        const Test = z.object({});
        `);
    });
    test("props.declarationProps & props.Declaration", async () => {
      ...
      const options = ZodCustomEmitOptions().forTypeKind("Model", {
        declare(props) {
          ...
          return ["// a model declaration", _$createIntrinsic("hbr", {}), _$createComponent(props.Declaration, _$mergeProps(() => props.declarationProps, {
    ...
    test("assembling parts", async () => {
      ...
      const options = ZodCustomEmitOptions().forTypeKind("Scalar", {
        declare(props) {
          return _$createComponent(props.Declaration, _$mergeProps(() => props.declarationProps, {
            get children() {
              return _$createComponent(MemberExpression, {
                get children() {
                  return [_$memo(() => props.baseSchemaParts()), _$memo(() => props.constraintParts()), _$memo(() => props.descriptionParts()), _$createComponent(MemberExpression.Part, {
                    id: "nifty"
                  })];
                }
              });
    ...
    test("derived scalars", async () => {
      ...
      const options = ZodCustomEmitOptions().forType(test.types[0], {
        declare(props) {
          return ["// a customized scalar declaration", _$createIntrinsic("hbr", {}), _$memo(() => props.default)];
        }
      });
      await expectOptionRender(test, options, `
  ...
  describe("customizing a reference", () => {
    test("default", async () => {
      ...
      const options = ZodCustomEmitOptions().forTypeKind("Model", {
        reference(props) {
          return ["/* a reference */", _$memo(() => props.default)];
        }
      });
      expectOptionRender(test, options, `
          const Test = z.object({});
          const RefTest = z.object({
    ...
    test("props.type and props.member", async () => {
      ...
      const options = ZodCustomEmitOptions().forType($(test.program).builtin.string, {
        reference(props) {
    ...
    test("assembling parts", async () => {
      ...
      const options = ZodCustomEmitOptions().forType($(test.program).builtin.string, {
        reference(props) {
          return _$createComponent(MemberExpression, {
            get children() {
              return [_$memo(() => props.baseSchemaParts), _$createComponent(MemberExpression.Part, {
                id: "member"
              }), _$memo(() => props.memberParts), _$createComponent(MemberExpression.Part, {
                id: "constraint"
              }), _$memo(() => props.constraintParts), _$createComponent(MemberExpression.Part, {
                id: "description"
              }), _$memo(() => props.descriptionParts)];
            }
          });
        }
      });
...
describe("end-to-end scenarios", () => {
  test("enum to union", async () => {
    ...
    const template = _$createComponent(ZodOptions, {
      customEmit: emitOptions,
      get children() {
        return _$createComponent(StatementList, {
          get children() {
...
//# sourceMappingURL=zod-options.test.js.map