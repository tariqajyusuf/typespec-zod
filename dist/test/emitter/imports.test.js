...
it("emits types from imported external packages", async () => {
  ...
  runner.fs.set("/test/node_modules/@custom-package/spec/package.json", JSON.stringify({
    name: "@custom-package/spec",
    version: "1.0.0",
    tspMain: "./main.tsp"
  }));
  runner.fs.set("/test/node_modules/@custom-package/spec/main.tsp", `
